...
def gen(obsix,simix,trendq,write=1,fname='sim_100kyr.dat',\
        simlen=66, locate=2041, xval=0, M=1):
    """ Main routine """
...
# not altered.
        yrpr,breaks0 = yrgen(pr)             # With trend and mean; not log
        yrma,breaks1 = yrgen(tmax)           # All breaks should be the same
        yrmi,breaks2 = yrgen(tmin)
        obslen = len(yrpr)
